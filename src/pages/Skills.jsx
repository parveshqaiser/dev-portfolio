...
const Skills =()=>{
    ...
    return (
    <section className="py-10 min-h-screen px-4  mx-auto bg-gradient-to-l from-black/80 via-black/85 to-black/95 text-white" id="skills">
        <div className="text-center mb-12">
            {/* <h2 className="text-4xl font-bold text-gray-400 mb-4">Technical Skills</h2> */}
